...
void MainMenu::Init(){
    m_context->m_assets->AddFont(AssetID::MAIN_FONT,"assets/fonts/Pacifico-Regular.ttf");
    m_gameTitle.setFont(m_context->m_assets->GetFont(AssetID::MAIN_FONT));
    m_gameTitle.setString("Snake Game");
    m_gameTitle.setOrigin(m_gameTitle.getLocalBounds().width/2.0f,
                          m_gameTitle.getLocalBounds().height/2.0f);
    m_gameTitle.setPosition(m_context->m_window->getSize().x/2,
                            m_context->m_window->getSize().y/2 -150.f);

    m_playButton.setFont(m_context->m_assets->GetFont(AssetID::MAIN_FONT));
    ...
    m_exitButton.setFont(m_context->m_assets->GetFont(AssetID::MAIN_FONT));
